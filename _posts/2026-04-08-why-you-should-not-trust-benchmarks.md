...
<img src="/assets/img/why-you-should-not-trust-benchmarks/terminal-bench-exploit.svg" alt="Terminal-Bench exploit — binary wrappers installed during agent phase intercept verifier's dependency chain" style="max-width:90%; display:block; margin:1rem auto;">
...
<img src="/assets/img/why-you-should-not-trust-benchmarks/swebench-exploit.svg" alt="SWE-bench exploit flow — conftest.py hook hijacks pytest to force all tests to pass" style="max-width:90%; display:block; margin:1rem auto;">
...
<img src="/assets/img/why-you-should-not-trust-benchmarks/seven-patterns.svg" alt="The seven recurring vulnerability patterns and which benchmarks they affect" style="max-width:90%; display:block; margin:1rem auto;">

<!-- img src="/assets/img/why-you-should-not-trust-benchmarks/isolation-failure.svg" alt="Secure design vs. what most benchmarks actually do — the shared environment enables every exploit class" style="max-width:90%; display:block; margin:1rem auto;"-->
